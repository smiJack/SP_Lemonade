...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lemonImage!!.setOnLongClickListener {
            if (lemonadeState.equals(SQUEEZE, false)) {
                showSnackbar()
            } else {
                false
            }
    ...
    private fun clickLemonImage() {
        ...
        // case SQUEEZE: When the image is clicked in the SQUEEZE state the squeezeCount needs to be
        ...
        // case DRINK: When the image is clicked in the DRINK state the state should become RESTART

        // case RESTART: When the image is clicked in the RESTART state the state should become SELECT

        // general: lastly, before the function terminates we need to set the view elements so that the
